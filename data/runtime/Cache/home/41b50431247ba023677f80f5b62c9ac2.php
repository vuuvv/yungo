...
<div id="hotel_c" class="menu_hotel">
	<div class="menu_w">
		...
		<div class="menu_right_hotel haveb">
			<ul class="b1">
				...
				<a title="<?php echo ($bcate["name"]); ?>" <?php if($tid == $bcate['id']): ?>class="onon"<?php endif; ?> href="<?php echo U('book/cate', array('cid'=>$bcate['id']));?>"><?php echo ($bcate["name"]); ?></a>
	...
	<div class="menu_w">
		...
		<div class="menu_right_hotel haveb">
			<a title="全部" href="<?php echo U('book/cate', array('cid'=>$cate_info['id'], 'sort'=>$sort));?>" class="on">全部</a>
			<ul class="b1">
				<li><a title="0-49元" href="<?php echo U('book/cate', array('cid'=>$cate_info['id'], 'sort'=>$sort, 'max_price'=>'49'));?>" <?php if($max_price == '49'): ?>class="onon"<?php endif; ?>>0-49元</a></li>
				<li><a title="50-99元" href="<?php echo U('book/cate', array('cid'=>$cate_info['id'], 'sort'=>$sort, 'min_price'=>'50', 'max_price'=>'99'));?>" <?php if($min_price == '50'): ?>class="onon"<?php endif; ?>>50-99元</a></li>
				<li><a title="100-199元" href="<?php echo U('book/cate', array('cid'=>$cate_info['id'], 'sort'=>$sort, 'min_price'=>'100', 'max_price'=>'199'));?>" <?php if($min_price == '100'): ?>class="onon"<?php endif; ?>>100-199元</a></li>
				<li><a title="200-499元" href="<?php echo U('book/cate', array('cid'=>$cate_info['id'], 'sort'=>$sort, 'min_price'=>'200', 'max_price'=>'499'));?>" <?php if($min_price == '200'): ?>class="onon"<?php endif; ?>>200-499元</a></li>
				<li><a title="500-999元" href="<?php echo U('book/cate', array('cid'=>$cate_info['id'], 'sort'=>$sort, 'min_price'=>'500', 'max_price'=>'999'));?>" <?php if($min_price == '500'): ?>class="onon"<?php endif; ?>>500-999元</a></li>
				<li><a title="1000元以上" href="<?php echo U('book/cate', array('cid'=>$cate_info['id'], 'sort'=>$sort, 'min_price'=>'1000'));?>" <?php if($min_price == '1000'): ?>class="onon"<?php endif; ?>>1000元以上</a></li>
			</ul>
		</div>
	</div>
